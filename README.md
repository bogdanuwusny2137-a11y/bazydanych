...
Strona hostowana jest na GitHub Pages. W repozytorium znajduje się plik `.nojekyll` (wyłącza przetwarzanie Jekyll), `robots.txt` oraz `sitemap.xml` dla lepszego SEO i indeksowania przez wyszukiwarki.
